...
let  mobile=document.getElementById("Mobiles");

mobile.addEventListener("click",()=>{

    let d=mobileData.filter((val,ind,arr)=>{

        return val["category"]=="smartphones"
...
fragrances.addEventListener("click",()=>{
    ...
    let d=mobileData.filter((val,ind,arr)=>{
        ...
        return val["category"]=="fragrances"
...
let homedecoration=document.getElementById("home-decoration")


homedecoration.addEventListener("click",()=>{

    let d=mobileData.filter((val,ind,arr)=>{

        return val["category"]=="home-decoration"
